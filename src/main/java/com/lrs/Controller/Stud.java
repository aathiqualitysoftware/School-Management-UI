...
public class Stud {
    ...
    @Lob
    @Column(name = "studentImageUploadId")
    private Long studentImageUploadId;
    ...
    @Column(name = "parentAadhar", length = 15)
    private String parentAadhar;
    @Column(name = "emergencyNumber", length = 10)
    private String emergencyNumber;
    @Lob
    @Column(name = "parentImageUploadId")
    private Long parentImageUploadId;
    @Lob
    @Column(name = "studentTcUploadId")
    private Long studentTcUploadId;

    @Column(name = "educationTypeId")
    private Long educationTypeId;
    @Column(name = "pincode", length = 6)
    private String pincode;
    @Column(name = "referalEmployeeId")
    private String referalEmployeeId;

    @Transient
    byte[] studentProfileImage;
    @Transient
    byte[] parentProfileImage;
    @Transient
    byte[] studentTcImage;
